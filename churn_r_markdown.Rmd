...
```{r warning=TRUE, cache=TRUE, include=FALSE, echo=TRUE, results='hide'}
...
```{r warning=FALSE, include=FALSE, cache=TRUE,  echo=TRUE, results='hide'}
...
Se observa que el **accuracy** del modelo **XGBoost** es de **0.616**, el de **GBM** es de **0.5653** y el de **Random Forest** es de **0.6338**. Esto indica que el modelo con mejor desempeño, en términos de exactitud, es **Random Forest**, por lo que sería el más adecuado para su implementación.
