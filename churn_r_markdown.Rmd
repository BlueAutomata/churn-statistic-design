...
packages <- c("readr", "readxl", "httr", "tidyverse", "lubridate", "mice", "caret", "corrplot")
...
```{r}
# Analizamos la variable "creditcd".
data$creditcd    <- as.factor(data$creditcd)
levels(data$creditcd)
```


Análisis: (Indica si el cliente posee una tarjeta de crédito.) Se puede observar que tiene 2 niveles (categorías).
...
```{r}
# Analizamos la variable "Customer_ID"
